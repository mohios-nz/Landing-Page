  ...
  const statistics = [
    {
      ...
      color: "from-[#8bada3]/20 to-[#8bada3]/5",
      hoverColor: "group-hover:from-[#8bada3]/30 group-hover:to-[#8bada3]/10",
    },
    {
  ...
  const costs = [
    {
      ...
      icon: <Clock className="h-10 w-10 text-[#8bada3]" />,
    ...
    },
    {
      ...
      icon: <TrendingDown className="h-10 w-10 text-[#8bada3]" />,
    ...
    },
    {
      ...
      icon: <AlertCircle className="h-10 w-10 text-[#8bada3]" />,
    ...
    },
    {
      ...
      icon: <HelpCircle className="h-10 w-10 text-[#8bada3]" />,
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {statistics.map((item, index) => (
            <div
              key={index}
              className={`group relative overflow-hidden rounded-xl border border-[#8bada3]/20 bg-white shadow-md transition-all duration-300 hover:shadow-lg ${
                activeIndex === index ? "ring-2 ring-[#8bada3] ring-offset-2" : ""
              }`}
            ...
            >
              ...
              <div className="relative p-6 z-10">
                ...
                <div className="flex items-end gap-2 mb-4">
                  <span className="text-4xl font-bold text-[#8bada3]">{item.statistic}</span>
                  <span className="text-sm text-gray-600 mb-1">{item.description}</span>
                </div>
                <div className="mt-4 pt-4 border-t border-[#8bada3]/10">
                  <p className="text-xs text-gray-500 italic">{item.source}</p>
                </div>
                <div
                  className="absolute bottom-0 left-0 h-1 bg-[#8bada3]"
                  style={{
        ...
        <div className="mt-20">
          ...
          <div className="relative mt-16 pt-10">
            {/* Connecting line */}
            <div className="absolute top-0 left-1/2 w-0.5 h-full bg-[#8bada3]/30 -translate-x-1/2 z-0"></div>
            ...
            <div className="space-y-16">
              {costs.map((cost, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute top-6 md:top-0 left-0 md:left-auto md:-left-6 md:-translate-x-[50%] w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center z-20 border border-[#8bada3]/20">
                    {cost.icon}
                  </div>

                  <div className="bg-white rounded-lg shadow-lg p-6 ml-16 md:ml-0 border border-[#8bada3]/20 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
